...
--Esta versión cambia el valor de toda la estructura de Campo Adicional de "IMPRESIÓN ETIQUETA".
...
BEGIN
    ...
    -- Actualizar el campo <CA_SI> a 'N' en STA11 cuando se modifique el precio en GVA17
    UPDATE STA11
    ...
    AND STA11.CAMPOS_ADICIONALES.value('(/CAMPOS_ADICIONALES/CA_INFORMACION_PARA_BALANZA)[1]', 'NVARCHAR(MAX)') = 'TIPO NO CONTROLA'
    AND i.NRO_DE_LIS = '10';
END;
