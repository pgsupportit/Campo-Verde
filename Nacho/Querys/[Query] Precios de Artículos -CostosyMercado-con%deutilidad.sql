...
SELECT 
	...
	CPA01.COD_PROVEE AS [CÓDIGO PROVEEDOR],
	CPA01.NOM_PROVEE AS [PROVEEDOR],
...
JOIN CPA15 ON STA11.COD_ARTICU = CPA15.COD_ARTICU
JOIN CPA01 ON CPA15.COD_PROVEE = CPA01.COD_PROVEE
...
GROUP BY 
	STA11.COD_ARTICU , STA11.DESCRIPCIO , GVA17.PRECIO , GVA10.NRO_DE_LIS , GVA10.NOMBRE_LIS , GVA17.FECHA_MODI, STA11.PORC_UTILI, CPA01.NOM_PROVEE, CPA01.COD_PROVEE
